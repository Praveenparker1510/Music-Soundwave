...
const EXTRA = [];
for (let i = 0; EXTRA.length < 120; i++) {
  const b = BASE_SONGS[i % BASE_SONGS.length];
  EXTRA.push({ ...b, title: b.title + " " + SUFFIXES[i % SUFFIXES.length] });
}
const SONGS = [...BASE_SONGS, ...EXTRA];

// Add beautiful placeholder photos based on the song's title and working MP3s
const MP3S = [
